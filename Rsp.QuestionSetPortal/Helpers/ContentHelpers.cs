        ...
        if (sections != null)
        {
            foreach (var questionSlot in sections)
            {
                ...
                if (associatedQuestion != null)
                {
                    ...
                    // map ranking properties
                    static string? GetAnswerOption(IEnumerable<IPublishedContent>? publishedContents)
                    {
                        ...
                        var contents = publishedContents.SingleOrDefault();

                        return (contents is AnswerOption answerOptoin) ? answerOptoin.OptionName : null;
                    }

                    questionModel.NhsInvolvment = GetAnswerOption(associatedQuestion.NhsInvolvement);
                    questionModel.NonNhsInvolvment = GetAnswerOption(associatedQuestion.NonNhsinvolvement);
