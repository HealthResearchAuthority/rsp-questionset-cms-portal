...
public class ModificationsQuestionsetController : ControllerBase
{
    ...
    public StartingQuestionsModel GetStartingQuestions(bool preview)
    {
    ...
    public QuestionSetModel GetModificationsJourney(string specificChangeId, bool preview)
    {
        var result = new QuestionSetModel();
        ...
        foreach (var section in children)
        {
            var sectionModel = new SectionModel
            {
                ...
                Questions = ContentHelpers.TransformQuestions(section, activeQuestionSet.VersionNumber.ToString()),
    ...
    private ModificationsQuestionSet? GetQuestionsetByVersion(bool preview = false)
    {
        ...
        if (questionsetRepo != null)
        {
            if (preview)
            {
                var previewQuestionSet = questionsetRepo.Value<IPublishedContent>("previewQuestionset") as ModificationsQuestionSet;
